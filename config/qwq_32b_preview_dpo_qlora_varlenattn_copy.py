...
max_epochs = 2
optim_type = AdamW
lr = 5e-4  # refer to alignment handbook
betas = (0.9, 0.999)
weight_decay = 0
...
evaluation_inputs = [
    'What exactly does element refer to in a set?',  # noqa: E501
    'If I want to categorize my books, can the concept of a set help me?',
    'Can mathematical induction be used to prove certain properties in geometry, such as the formula for the sum of interior angles of a polygon?'
]
...
train_dataset = dict(
    ...
    dataset=dict(type=load_jsonl_dataset, data_files=[dpo_data_path]),
    tokenizer=tokenizer,
